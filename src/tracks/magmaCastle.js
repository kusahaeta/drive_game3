...
export default {
  ...
  boostPads: [
    { at: 0.045, lateral: 0, width: 6 },
    { at: 0.27, lateral: -3 },
    { at: 0.86, lateral: 3 },
  ],
  features: [
    // スタート直後、ダッシュ板→ジャンプ台で溶岩の裂け目を飛び越える
    { type: "ramp", at: 0.055, length: 10, height: 2.4 },
    { type: "gap", from: 0.0621, to: 0.0741 },
    // 東側の溶岩に架かる石橋
