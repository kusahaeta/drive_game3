 ...
 * 両側が切り立った尾根の S 字 → バンク付きの連続ヘアピン → 峡谷の裂け目を大ジャンプ → 雷の落ちる谷底の橋 →
 * つむじ風の吹く登り → 柵のない崖っぷち → 台地を貫くトンネル → つむじ風を抜け、ヘアピン 2 つでゴール。
...
export default {
  ...
  description: "峡谷の台地を駆ける上級者向けコース。細い道と柵のない崖、連続ヘアピン、裂け目ジャンプ。雷雲の落雷とつむじ風にも注意。",
  laps: 3,
  roadWidth: 14,
  shoulderWidth: 3,
  // [x, 高さ, z]。1点目がスタートライン。
  ...
  hazards: [
    // 尾根の手前で雷雲が車の行く先に雷を落とす（黄色い印の所に落ちる）
    { type: "lightning", from: 0.12, to: 0.2, interval: 2.2 },
    // 近道の上空にも雷雲
    { type: "lightning", branch: 1, from: 0.2, to: 0.85, interval: 2 },
    // 谷底へ下る道は雷雲 2 つ
    { type: "lightning", from: 0.44, to: 0.515, count: 2, interval: 2.6 },
    // 登り坂をつむじ風が蛇行しながら行き来する（巻き込まれると放り上げられる）
    { type: "tornado", from: 0.59, to: 0.66, count: 2, speed: 7 },
    // トンネルを抜けた先にもつむじ風
    { type: "tornado", from: 0.84, to: 0.895, count: 1, speed: 6 },
  ],
  theme: {
    skyTop: "#2f6fc8",
    skyBottom: "#f7d9a8",
